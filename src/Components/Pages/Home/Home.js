                ...
                <div className="row">
                    <div className="banner py-5 px-4">
                        <div className='banner-text col-lg-6 py-5'>
                            ...
                            <p className='text-white'>Producing Safe,  Food For Everyone, In A Sustainable And Affordable Manner. Discover The Latest Trends And Innovations For A Sustainable Future. Find Out More! UK. Charity No. 1040519. Join Our Movement. International Non-Profit. Support Our Work.</p>
